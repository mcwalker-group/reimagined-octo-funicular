...
input_training_file = 'classIV_training_set_matrix.csv'         # the CSV containing the training set
input_fitting_file = 'classIV-peps-params-1007-feats.csv'          # the CSV containing the data to be fitted
output_filename = 'classIV-peps-params-1007-feats-classified.csv'     # output filename; this will be a CSV with the first column being the primary key and the second being the classification
