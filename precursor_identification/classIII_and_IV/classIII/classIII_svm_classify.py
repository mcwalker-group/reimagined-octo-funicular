...
input_training_file = 'classIII_training_set_matrix.csv'         # the CSV containing the training set
input_fitting_file = 'classIII-peps-params-1877-feats.csv'          # the CSV containing the data to be fitted
output_filename = 'classIII-peps-classified.csv'     # output filename; this will be a CSV with the first column being the primary key and the second being the classification
