...
input_training_file = 'classI_training_set_matrix.csv'         # the CSV containing the training set
input_fitting_file = 'classI-peps-params-854-feats-for-svm.csv'          # the CSV containing the data to be fitted
output_filename = 'classI-peps-classification.csv'     # output filename; this will be a CSV with the first column being the primary key and the second being the classification
...
C_option = 283117.0561241
gamma_option = 9.99999999999999E-08
